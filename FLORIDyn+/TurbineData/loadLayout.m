function [T,fieldLims,VCpCt,chain] = loadLayout(layout, varargin)
...
% Turbine data
position        = [400 500 119 178.4;...
            1300 500 119 178.4];  
fieldLim        = [0 0; 2000 1000]; % Field limits    
...
%         assignin('caller', varName, varValue);  % assign variable in the caller workspace
%     end
% end
...
switch layout
    case "Customizable"
        ...
        % Loading in turbine data
        T.VCpCt = load('./TurbineData/DTU10MW/VCpCt_10MW_SOWFA.mat');
        VCpCt = T.VCpCt.VCpCt;

        T.VCtCp = load('.\TurbineData\IEA22MW\Wind_Cp_Ct_Beta_Omega_IEA22MW.mat');
        T.CpCtTSR = load('.\TurbineData\IEA22MW\Cp_Ct_Beta_TSR_IEA22MW.mat');
        T.param = load('.\TurbineData\IEA22MW\Param_IEA22MW.mat');          
    case 'oneDTU10MW'
